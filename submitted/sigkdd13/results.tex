...
\begin{table}[!h]
  \centering
    \begin{tabular}{|c|c|c|c|c|}
      \hline
      Dataset & $|V|$ & $|E|$ & $|\Sigma|$ & \small{Pre processing time(sec)} \\
      \hline
	  ...
	  \hline
    \end{tabular}
    \caption{Dataset Properties. Pre processing time is for computing the \khop labels of database vertices for $k \leq 6$.}
	\label{tab:db}
\end{table}
\end{comment}
