...
postman problem \cite{chinesepostman} where the distance between every pair of
...
vertex $1$ to $30$. The total cost of matching these labels is $0.2$ and
...
w_p$, if $u_i$ and $u_{i+1}$ are already mapped, then we verify that there is an edge
