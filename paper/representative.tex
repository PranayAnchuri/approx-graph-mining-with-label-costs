...
\notin R'(2)$. This example illustrates that \khop labels can help
...
\medskip{\textit{Optimization}: } The candidate pattern may contain groups of symmetric
...
It only takes a couple of minutes to compute the \khop label for 
